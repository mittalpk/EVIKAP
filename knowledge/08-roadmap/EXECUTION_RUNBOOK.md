...
- [x] Replace `GitHubSearchSubsystem`/wiki keyword search with embedding + hybrid retrieval (FR-002), mapping and populating relational metadata fields during ingestion. GitHub embedding ingestion connector implemented 2026-07-23 (US-006, `backend/app/services/github_connector.py`, tests: `backend/tests/test_github_connector.py`).
